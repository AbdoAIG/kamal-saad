...
export default function ProductPage() {
  ...
  // Parse images
  const images = product ? (Array.isArray(JSON.parse(product.images || '[]')) ? JSON.parse(product.images || '[]') : []) : [];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900" dir={isArabic ? 'rtl' : 'ltr'}>
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className={`flex flex-wrap items-center gap-4 ${isArabic ? 'flex-row-reverse' : ''}`}>
                ...
                <div className={`flex items-center gap-1 bg-gray-100 dark:bg-gray-800 rounded-xl p-1 ${isArabic ? 'flex-row-reverse' : ''}`}>
                  ...
                  <Button variant="ghost" size="icon" className="h-10 w-10 rounded-lg bg-white dark:bg-gray-700 shadow-sm" onClick={() => setQuantity(Math.min(product.stock, quantity + 1))} disabled={quantity >= product.stock}>
              ...
              <div className={`flex gap-2 sm:gap-3 ${isArabic ? 'flex-row-reverse' : ''}`}>
                ...
                <Button variant="outline" size="icon" className="h-12 w-12 sm:h-14 sm:w-14 rounded-xl shrink-0">

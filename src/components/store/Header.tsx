          ...
          <div className="flex items-center justify-between h-16 lg:h-20 gap-3">
            ...
            <Link href="/" className="flex items-center group flex-shrink-0">
              <motion.div 
                ...
                className="relative h-24 lg:h-28 w-24 lg:w-28"
              >
                <img
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="sm" className="flex gap-2 h-9 rounded-full hover:bg-blue-50 dark:hover:bg-blue-900/30">
                      ...
                      <span className="text-gray-700 dark:text-gray-300 text-sm hidden md:inline">{user.name}</span>
                    </Button>
                  </DropdownMenuTrigger>
                ...
                <Button
                  variant="ghost"
                  className="flex gap-2 h-9 rounded-full hover:bg-blue-50 dark:hover:bg-blue-900/30"
                  onClick={() => toggleAuthModal('login')}
                >
                  <User className="h-5 w-5 text-gray-600 dark:text-gray-300" />
                  <span className="text-gray-700 dark:text-gray-300 text-sm hidden md:inline">{t('login', language)}</span>
                </Button>
              )}

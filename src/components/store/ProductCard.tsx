              ...
              <div className="relative w-full h-full flex items-center justify-center p-4">
                {images.map((img, idx) => (
                  <motion.img
                    ...
                    className="w-full h-full object-contain max-w-[95%] max-h-[95%] group-hover:scale-105 transition-transform duration-300"
                    ...
                    style={{ zIndex: currentImageIndex === idx ? 1 : 0, position: 'absolute' }}
                  />
                ))}
              </div>
            ) : (

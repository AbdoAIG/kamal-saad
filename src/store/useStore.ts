...
export const translations = {
  ar: {
    ...
    viewAll: 'عرض الكل',
    freeShipping: 'توصيل مجاني للطلبات فوق 200 جنيه',
    studentDiscount: 'خصم 15% على طلاب المدارس',
    heroTitle: 'كل ما تحتاجه',
    heroTitleHighlight: 'للمدرسة والمكتب',
    heroSubtitle: 'اكتشف تشكيلتنا الواسعة من المستلزمات المدرسية والمكتبية بأفضل الأسعار',
    shopNow: 'تسوق الآن',
    ...
    noProductsDesc: 'لا توجد منتجات تطابق معايير البحث',
    emptyCart: 'سلة التسوق فارغة',
    emptyCartDesc: 'لم تضف أي منتجات بعد',
    emptyFavorites: 'المفضلة فارغة',
    emptyFavoritesDesc: 'لم تضف أي منتجات للمفضلة',
  ...
  en: {
    ...
    viewAll: 'View All',
    freeShipping: 'Free shipping on orders over 200 EGP',
    studentDiscount: '15% discount for students',
    heroTitle: 'Everything You Need',
    heroTitleHighlight: 'For School & Office',
    heroSubtitle: 'Discover our wide range of school and office supplies at the best prices',
    shopNow: 'Shop Now',
    ...
    emptyFavoritesDesc: 'You haven\'t added any products to favorites',
